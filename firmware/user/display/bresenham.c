...
void ICACHE_FLASH_ATTR plotEllipseRect(int x0, int y0, int x1, int y1) { /* rectangular parameter enclosing the ellipse */
...
void ICACHE_FLASH_ATTR plotQuadBezierSeg(int x0, int y0, int x1, int y1, int x2, int y2) { /* plot a limited quadratic Bezier segment */
...
void ICACHE_FLASH_ATTR plotQuadBezier(int x0, int y0, int x1, int y1, int x2, int y2) { /* plot any quadratic Bezier curve */
    int x = x0 - x1, y = y0 - y1;
...
void ICACHE_FLASH_ATTR plotRotatedEllipse(int x, int y, int a, int b, float angle) { /* plot ellipse rotated by angle (radian) */
...
void ICACHE_FLASH_ATTR plotRotatedEllipseRect(int x0, int y0, int x1, int y1, long zd) { /* rectangle enclosing the ellipse, integer rotation angle */
