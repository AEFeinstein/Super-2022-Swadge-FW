...
uint8_t ICACHE_FLASH_ATTR intervalsmeet(FLOATING a,FLOATING c,FLOATING b,FLOATING d,FLOATING e,FLOATING f, FLOATING param[]);
uint8_t ICACHE_FLASH_ATTR  gonethru(FLOATING b_prev[], FLOATING b_now[], FLOATING p_1[], FLOATING p_2[], FLOATING rball, FLOATING b_nowadjusted[], FLOATING param[]);
...
FLOATING swxleft[MAXNUMWALLS];
FLOATING swxright[MAXNUMWALLS];
FLOATING swytop[MAXNUMWALLS];
FLOATING swybot[MAXNUMWALLS];
/*============================================================================
 * Functions
 *==========================================================================*/
